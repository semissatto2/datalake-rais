  ...
  policy = <<EOF
{
    ...
    "Statement": [
        ...
        {
          "Action": "iam:PassRole",
          "Resource": ["arn:aws:iam::338766793851:role/EMR_DefaultRole",
                       "arn:aws:iam::338766793851:role/EMR_EC2_DefaultRole"],
          "Effect": "Allow"
        }
    ]
}
...
resource "aws_iam_role" "glue_role" {
  name               = "semissatto_Role_GlueCrawler_rais"
  path               = "/"
...
resource "aws_iam_policy" "glue_policy" {
  name        = "semissatto_Policy_GlueCrawler_rais"
  path        = "/"
  description = "Provides write permissions to CloudWatch Logs and S3 Full Access"
